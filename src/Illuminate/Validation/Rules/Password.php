...
class Password implements ImplicitRule, DataAwareRule, ValidatorAwareRule
{
    use Conditionable;
    ...
    public function passes($attribute, $value)
    {
        ...
        if (! $this->required && ! Arr::has($this->data, $attribute)) {
            return true;
        }

        if ($value === null && $this->validator->hasRule($attribute, 'Nullable')) {
            return true;
        }
